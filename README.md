...
A browser implementation of the classic **2048** puzzle game, built with vanilla JavaScript. Merge matching tiles by moving them with the arrow keys to reach the 2048 tile and beyond.
